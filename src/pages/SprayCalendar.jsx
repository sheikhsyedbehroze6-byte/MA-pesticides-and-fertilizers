  ...
  return (
    <div className="container" style={{ paddingBottom: '5rem' }}>
      ...
      <AnimatedSection delay={0.1} style={{ 
        ...
        {/* Crop Urdu Title */}
        {langMode !== 'en' && (
          <p className="urdu-text" dir="rtl" style={{ margin: '1rem 0 0 0', fontSize: '1.1rem', color: 'var(--primary-color)', fontWeight: 'bold' }}>
            {cropData.urduTitle}
          </p>
        )}
      </AnimatedSection>
            ...
            return (
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '6px', flexWrap: 'wrap', marginBottom: '0.4rem' }}>
                  <span style={{ fontSize: '0.72rem', fontWeight: 'bold', color: 'var(--primary-color)', background: 'var(--primary-glow)', padding: '2px 8px', borderRadius: '12px', display: 'inline-block' }}>
                ...
                {(langMode === 'both' || langMode === 'en') && (
                  <h4 style={{ margin: '4px 0 0 0', fontSize: '0.95rem', color: 'var(--text-main)' }}>{stage.title}</h4>
                )}
                {(langMode === 'both' || langMode === 'ur') && (
                  <h4 className="urdu-text" dir="rtl" style={{ margin: '4px 0 0 0', fontSize: '1rem', color: 'var(--primary-color)', fontWeight: 'bold' }}>
                    {stage.titleUrdu}
                  </h4>
                )}
              </div>
              ...
              >
                <div style={{ borderBottom: '1px solid var(--border-color)', paddingBottom: '1rem', marginBottom: '1.5rem' }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '8px', marginBottom: '0.6rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--primary-color)', fontWeight: 'bold', fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginTop: '0.4rem' }}>
                    ...
                    {langMode !== 'en' && (
                      <span className="urdu-text" style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>
                        — {stage.timingUrdu}
                      </span>
                    )}
                  </div>
                ...
                <div style={{ background: 'var(--bg-main)', border: '1px solid var(--border-color)', borderRadius: '12px', padding: '1rem', marginBottom: '1.2rem' }}>
                  ...
                  {/* Dosage */}
                  <div style={{ marginTop: '0.8rem', display: 'flex', gap: '8px', alignItems: 'flex-start', borderTop: '1px solid var(--border-color)', paddingTop: '0.8rem' }}>
                    <Droplets size={16} color="var(--primary-color)" style={{ flexShrink: 0, marginTop: '2px' }} />
                    <div>
                      {(langMode === 'both' || langMode === 'en') && (
                        <div style={{ fontSize: '0.9rem', color: 'var(--text-main)' }}><strong>SKUAST-K Dilution:</strong> {stage.dosage}</div>
                      )}
                      {(langMode === 'both' || langMode === 'ur') && (
                        <div className="urdu-text" dir="rtl" style={{ fontSize: '0.95rem', color: '#163e24', marginTop: '3px' }}><strong>تجویز کردہ مقدار:</strong> {stage.dosageUrdu}</div>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div style={{ background: 'rgba(196, 160, 84, 0.05)', border: '1px solid rgba(196, 160, 84, 0.2)', borderRadius: '12px', padding: '1rem', marginBottom: '1.5rem' }}>
                  ...
                  {(langMode === 'both' || langMode === 'en') && (
                    <p style={{ margin: 0, fontSize: '0.85rem', color: 'var(--text-main)', lineHeight: '1.6' }}>{stage.notes}</p>
                  )}
                  {(langMode === 'both' || langMode === 'ur') && (
                    <p className="urdu-text" dir="rtl" style={{ margin: '4px 0 0 0', fontSize: '0.95rem', color: '#163e24', lineHeight: '1.7' }}>{stage.notesUrdu}</p>
                  )}
                </div>
